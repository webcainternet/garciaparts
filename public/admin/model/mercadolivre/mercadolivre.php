...
{    
	  ...
	  /* end ML attribute*/  
		 ...
		 if($this->config->get('mercadolivre_image_in_desc')){
			  foreach($list_images as $single_img){
				 $product['description']='<center><img src="'.$single_img['source'].'" border="0" /></center><br />'.$product['description'];  
			  } 
		 }  
    ...
    public function uninstall(){
         ...
         $this->safeColumnDrop('product',array('mercaId','mercaCurrency','mercaBuyMode','mercaListType','mercaCondition','mercaTree','mercaWarranty','mercaVideoId','mercaShipping', 'mercaReposting'));
	...
	public function isDBBUPdateAvail(){
		  ...
		  $product_columns=array('mercaId','mercaCurrency','mercaBuyMode','mercaListType','mercaCondition','mercaTree','mercaWarranty','mercaVideoId','mercaShipping', 'mercaReposting', 'mercaGoogle');
