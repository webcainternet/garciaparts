 ...
 */
 ...
 echo '<br />ou <span style="font-size: 22px; font-weight: bold; color: #7FCE58;">' . $qtd_parcelas . 'x</span> de <span style="font-size: 22px; font-weight: bold; color: #7FCE58;">' . $moeda_da_loja . number_format($valor_parcela, 2, ',', '.');
